"""
Round 20: Triple OR v2 — Looser Return Sign (TH=0.55)
======================================================
R18 Triple OR hit $9,863 OOS (98.6%). R19 Quad OR (add Wick) $9,423 worse.
Back to Triple OR, use SR_TH=0.55 from R16 robustness grid.

R16 robustness evidence for TH=0.55:
  W=12 TH=0.55: OOS $8,021
  W=15 TH=0.55: OOS $6,814
  W=18 TH=0.55: OOS $7,247
  Mean: $7,361 — vs TH=0.60 mean $6,490 — systematically superior.
  All 3 combinations OOS positive. Not cherry-picked.

Change: SR_LT 0.60→0.55, SR_ST 0.40→0.45 (looser = more momentum entries)
...
SR_WIN=15;SR_LT=0.55;SR_ST=0.45  # <-- CHANGED from 0.60/0.40
...
if __name__=="__main__":
    print("="*60)
    print("  Round 20: Triple OR v2 (SR_TH=0.55)")
    print("="*60)
    df=load();df=calc(df)
    ...
    print(f"    [4] Params pre-fixed?: YES: GK Champion, Skew R1, Sign R16 robust grid TH=0.55")
